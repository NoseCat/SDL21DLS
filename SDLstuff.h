...
//линейная интерполяция от a до b с шагом t (t - процент от разницы между a и b) 
...
//Поворачивает точку point на угол относительно rotationPoint почасовой стрелке
...
//Возвращает точку пересечения двух линий заданых отрезками
